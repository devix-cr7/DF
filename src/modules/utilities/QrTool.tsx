    ...
    <ToolShell title="QR Code Generator" description="Turn any text or URL into a scannable code">
      <div className="flex h-full flex-col items-center gap-6 md:flex-row md:items-start md:justify-center">
        <div className="flex w-full max-w-sm flex-col gap-3">
          <label className="text-xs font-semibold text-forge-muted">Content</label>
          <textarea
            value={text}
          ...
          <div className="flex gap-4">
            <div className="flex flex-1 items-center gap-2">
              <label className="text-xs text-forge-muted">Foreground</label>
              <input
                type="color"
                value={fg}
            ...
            <div className="flex flex-1 items-center gap-2">
              <label className="text-xs text-forge-muted">Background</label>
              <input
                type="color"
                value={bg}
